...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.):
        ...
        self.attn = SNRMultiHeadAttention(dim, num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, proj_drop=drop)
...
class SNRTransformer(nn.Module):
    ...
    def __init__(self, dim, patch_size=8, depth=6, num_heads=8, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.):
        ...
        self.blocks = nn.ModuleList([
            TransformerBlock(dim=dim, num_heads=num_heads, mlp_ratio=mlp_ratio, qkv_bias=qkv_bias, drop=drop, attn_drop=attn_drop)
